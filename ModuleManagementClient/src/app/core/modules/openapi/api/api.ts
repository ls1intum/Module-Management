...
export * from './module-controller.serviceInterface';
...
export const APIS = [FeedbackControllerService, ModuleControllerService, ModuleVersionControllerService, ProposalControllerService];

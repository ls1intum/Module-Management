...
export class StatusInfoPipeline implements PipeTransform {
  transform(status: Proposal.StatusEnum): string {
    switch (status) {
      case 'PENDING_SUBMISSION':
        return 'This module proposal is pending submission. Please complete fill all module information fields and submit the module proposal. After submission the necessary staff will be notified to review your proposal.';
      case 'PENDING_FEEDBACK':
        return 'This module proposal is submitted and waiting for review by the necessary staff. Please wait for their feedback. If you made a mistake cou can cancel the submission. If a staff member already gave feedback, you will need to create a new module version for consistency. New module versions copy the content of the previously submitted module version.';
      case 'ACCEPTED':

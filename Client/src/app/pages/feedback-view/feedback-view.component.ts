...
export class FeedbackViewComponent {
  ...
  moduleFields = [
    ...
    { key: 'examinationAchievementsPromptEng', label: 'Examination Prompt' },
    ...
    { key: 'contentPromptEng', label: 'Content Prompt' },
    { key: 'learningOutcomesEng', label: 'Learning Outcomes' },
    { key: 'learningOutcomesPromptEng', label: 'Learning Outcomes Prompt' },
    { key: 'teachingMethodsEng', label: 'Teaching Methods' },
    { key: 'teachingMethodsPromptEng', label: 'Teaching Methods Prompt' },
  ...
  constructor(formBulider: FormBuilder, route: ActivatedRoute) {
    ...
    this.feedbackForm = formBulider.group({
      ...
      examinationAchievementsPromptAccepted: [null],
      examinationAchievementsPromptFeedback: [''],
      ...
      contentFeedback: [''],
      contentPromptAccepted: [null],
      contentPromptFeedback: [''],
      learningOutcomesAccepted: [null],
      learningOutcomesFeedback: [''],
      learningOutcomesPromptAccepted: [null],
      learningOutcomesPromptFeedback: [''],
      teachingMethodsAccepted: [null],
      teachingMethodsFeedback: [''],
      teachingMethodsPromptAccepted: [null],
      teachingMethodsPromptFeedback: [''],
      mediaAccepted: [null],
      mediaFeedback: [''],
